...
`settings.yaml` с урезанным списком — он gitignored (твои правки
не уедут в git), и сканер автоматически возьмёт его вместо
`settings.example.yaml`. Минимум — 1 пара, ограничения нет.
